    ...
    return {
        ...
        "layers": [
            ...
            },
            {
                ...
                "surfaces": [
                    {"cmd": "market optimize-purchase <items> --country PE", "use": "Compra óptima en un solo llamado: TCO + delivery + acción directa (Wave 4)"},
                    ...
                    {"cmd": "GET /v1/missions/optimize-purchase", "use": "Compra óptima vía API (Wave 4) — reemplaza search → compare → basket"},
                    {"cmd": "GET /v1/intel/inflation?days=7", "use": "Inflación por línea vía API para agentes"},
                    {"cmd": "GET /v1/intel/affordability?country=PE", "use": "Score de asequibilidad 0-100 con TCO y ratio salario/canasta"},
                    {"cmd": "GET /v1/basket/tco?country=PE", "use": "Costo total de propiedad de canasta con delivery incluido"},
...
def _dashboard_data():
    ...
    try:
        ...
        db.close()  # now unconditional -- an exception before the old unconditional close() (found 2026-08-05) leaked a connection every time
    ...
    result = {
        ...
        "moat_summary": {
            ...
            "health_breakdown": health_breakdown,
            "agent_surfaces": [
                "market_optimize_purchase", "market compare", "market basket",
                "market intel indicators", "market intel scores", "market intel enrichment",
                "market intel inflation",
                "/v1/missions/optimize-purchase", "/v1/intel/inflation", "/v1/intel/scores",
                "/v1/intel/affordability", "/v1/basket/tco",
                "/v1/intel/enrichment", "/v1/intel/enrichment/subcategories",
                "/analytics/indicators", "MCP market_stats",
            ],
        },
